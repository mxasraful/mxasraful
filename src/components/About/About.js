...
import './About.css';
import pImg from './../../img/asraful_photo_1.jpg'
                    ...
                    <div className="aboutText aboutS">
                        ...
                        <h3 className="text-left text-light">
                            ...
                            <div className='about-main-text'>
                                <h4>I'm Mx Asraful. My Full Name Is Asraful Islam. I'm an Entrepreneur. And I am also a Programmer. I can create any web application. I do programming professionally and with pleasure. I have over 3 years of experience in web development. Also I am a tech youtuber. I have a YouTube channel called Tech with Asraful where I publish tech-related videos.</h4>
                                <br />
